  ...
  function DrawIntra(data) {
    ...
    fetch("https://zone01normandie.org/api/graphql-engine/v1/graphql", {
      ...
      .then((data) => {
        ...
        upText.textContent = `Donné: ${(data2.totalUp * 10e-7).toFixed(2)} MB`;
        ...
        downRect.setAttribute("fill", "lightgreen"); 
        ...
        downText.textContent = `Reçu: ${(data2.totalDown * 10e-7).toFixed(2)} MB`;
